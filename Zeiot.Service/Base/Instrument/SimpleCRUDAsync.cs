...
namespace Zeiot.Service.Base.Instrument
{
    ...
    {
        /// <summary>
        /// <parameters>By default queries the table matching the class name asynchronously </parameters>
        /// <parameters>-Table name can be overridden by adding an attribute on your class [Table("YourTableName")]</parameters>
        /// <parameters>By default filters on the Id column</parameters>
        /// <parameters>-Id column name can be overridden by adding an attribute on your primary key property [Key]</parameters>
        /// <parameters>Supports transaction and command timeout</parameters>
        /// <parameters>Returns a single entity by a single id from table T</parameters>
        /// </summary>
        ...
        /// <parameters>By default queries the table matching the class name asynchronously</parameters>
        /// <parameters>-Table name can be overridden by adding an attribute on your class [Table("YourTableName")]</parameters>
        /// <parameters>whereConditions is an anonymous type to filter the results ex: new {Category = 1, SubCategory=2}</parameters>
        /// <parameters>Supports transaction and command timeout</parameters>
        ...
        /// <parameters>By default queries the table matching the class name asynchronously</parameters>
        /// <parameters>-Table name can be overridden by adding an attribute on your class [Table("YourTableName")]</parameters>
        /// <parameters>Returns a list of all entities</parameters>
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="connection"></param>
        ...
        /// <summary>
        /// <parameters>Inserts a row into the database asynchronously</parameters>
        /// <parameters>By default inserts into the table matching the class name</parameters>
        /// <parameters>-Table name can be overridden by adding an attribute on your class [Table("YourTableName")]</parameters>
        /// <parameters>Insert filters out Id column and any columns with the [Key] attribute</parameters>
        /// <parameters>Properties marked with attribute [Editable(false)] and complex types are ignored</parameters>
        /// <parameters>Supports transaction and command timeout</parameters>
        /// <parameters>Returns the ID (primary key) of the newly inserted record if it is identity using the int? type, otherwise null</parameters>
        /// </summary>
        /// <param name="connection"></param>
        ...
        /// <summary>
        /// <parameters>Inserts a row into the database, using ONLY the properties defined by TEntity</parameters>
        /// <parameters>By default inserts into the table matching the class name</parameters>
        /// <parameters>-Table name can be overridden by adding an attribute on your class [Table("YourTableName")]</parameters>
        /// <parameters>Insert filters out Id column and any columns with the [Key] attribute</parameters>
        /// <parameters>Properties marked with attribute [Editable(false)] and complex types are ignored</parameters>
        /// <parameters>Supports transaction and command timeout</parameters>
        /// <parameters>Returns the ID (primary key) of the newly inserted record if it is identity using the defined type, otherwise null</parameters>
        /// </summary>
        /// <param name="connection"></param>
        /// <param name="entityToInsert"></param>
        /// <param name="transaction"></param>
        ...
        /// <summary>
        ///  <parameters>Updates a record or records in the database asynchronously</parameters>
        ///  <parameters>By default updates records in the table matching the class name</parameters>
        ///  <parameters>-Table name can be overridden by adding an attribute on your class [Table("YourTableName")]</parameters>
        ///  <parameters>Updates records where the Id property and properties with the [Key] attribute match those in the database.</parameters>
        ///  <parameters>Properties marked with attribute [Editable(false)] and complex types are ignored</parameters>
        ///  <parameters>Supports transaction and command timeout</parameters>
        ///  <parameters>Returns number of rows affected</parameters>
        ///  </summary>
        ///  <param name="connection"></param>
        ...
        /// <summary>
        /// <parameters>Deletes a record or records in the database that match the object passed in asynchronously</parameters>
        /// <parameters>-By default deletes records in the table matching the class name</parameters>
        /// <parameters>Table name can be overridden by adding an attribute on your class [Table("YourTableName")]</parameters>
        /// <parameters>Supports transaction and command timeout</parameters>
        /// <parameters>Returns the number of records affected</parameters>
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="connection"></param>
        ...
        /// <summary>
        /// <parameters>Deletes a record or records in the database by ID asynchronously</parameters>
        /// <parameters>By default deletes records in the table matching the class name</parameters>
        /// <parameters>-Table name can be overridden by adding an attribute on your class [Table("YourTableName")]</parameters>
        /// <parameters>Deletes records where the Id property and properties with the [Key] attribute match those in the database</parameters>
        /// <parameters>The number of records affected</parameters>
        /// <parameters>Supports transaction and command timeout</parameters>
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="connection"></param>
        ...
        /// <summary>
        /// <parameters>Deletes a list of records in the database</parameters>
        /// <parameters>By default deletes records in the table matching the class name</parameters>
        /// <parameters>-Table name can be overridden by adding an attribute on your class [Table("YourTableName")]</parameters>
        /// <parameters>Deletes records where that match the where clause</parameters>
        /// <parameters>whereConditions is an anonymous type to filter the results ex: new {Category = 1, SubCategory=2}</parameters>
        /// <parameters>The number of records affected</parameters>
        /// <parameters>Supports transaction and command timeout</parameters>
        /// </summary>
        ...
        /// <parameters>-Table name can be overridden by adding an attribute on your class [Table("YourTableName")]</parameters>
        /// <parameters>Deletes records where that match the where clause</parameters>
        /// <parameters>conditions is an SQL where clause ex: "where name='bob'" or "where age>=@Age"</parameters>
        /// <parameters>parameters is an anonymous type to pass in named parameter values: new { Age = 15 }</parameters>
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="connection"></param>
