...
namespace socket.Core.Client
{
    ...
    public class UdpClients
    {
        ...
        /// <returns></returns>
        public static async System.Threading.Tasks.Task<int> AsyncSendParameter(byte[] data, string ip, string port)
        {
            try
            {
                if (data != null && data.Length > 0)
                {
                    ...
                    await System.Threading.Tasks.Task.Delay(1000).ConfigureAwait(false);  // 解决死锁
