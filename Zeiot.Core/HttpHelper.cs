...
namespace Zeiot.Core
{
    ...
    public  class HttpHelper
    {
        ...
        public static string HttpGet(string Url, string postDataStr ,Dictionary<string, string> headers=null)
        {
        ...
        /// <param name="headers">headers</param>
        /// <returns>System.String.</returns>
        public static string HttpPost(string posturl, string postData, Dictionary<string, string> headers = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool IsHttpPost(string url, string content)
        {
            try
            {
                //获取提交的字节
        ...
        private void SetCer(HttpItem objhttpItem)
        {
            if (!string.IsNullOrEmpty(objhttpItem.CerPath))
            {
                ...
                //初始化对像，并设置请求的URL地址
                request = (HttpWebRequest)WebRequest.Create(GetTrueUrl(objhttpItem.URL));
                //创建证书文件
